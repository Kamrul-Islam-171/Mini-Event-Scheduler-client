        ...
        <tbody>
          {events?.map((event: TEvent) => (
            <tr key={event?.id} className="duration-300">
              ...
              <td className="p-2">{event?.archived? 'Archived' : 'Not Archived'}</td>
              <td>
              ...
              <td>
                <button onClick={() => openUpdateConfirm(event?.id)} className="flex justify-center items-center button1  cursor-pointer  hover:bg-[var(--primary-color)] w-full py-2">
